...
In this example, we will use a \texttt{Qwen2.5-0.5B} model \sidenote{\refch{chapter:local} presents some remarkable performance data on Qwen2.5 models, which are one of them best Open Source models available today}, a lightweight open source model from Alibaba Cloud known for its strong performance despite its small size.
